...
TInt32 IfServiceCenterSkeleton::HandleMsg(CMessageHeader *pMsg)
{
    ...
    {
        {(SERVICECENTER_SERVICE_ID|IFSERVICECENTER_INTERFACE_ID|ONSERIVCESTARTED_TUINT32_CONST_TCHAR_PT_CDOID_ID), &IfServiceCenterSkeleton::HandleOnSerivceStarted_TUInt32_const_TChar_pt_CDoid},
        {(SERVICECENTER_SERVICE_ID|IFSERVICECENTER_INTERFACE_ID|ONSERVICESTOPED_TUINT32_CDOID_ID), &IfServiceCenterSkeleton::HandleOnServiceStoped_TUInt32_CDoid},
        {(SERVICECENTER_SERVICE_ID|IFSERVICECENTER_INTERFACE_ID|SERVICESTATIC_TUINT32_CDOID_TLV_TPL_BEGIN_TUINT16_AND_TUINT16_TPL_END__ID), &IfServiceCenterSkeleton::HandleServiceStatic_TUInt32_CDoid_TLV_tpl_begin_TUInt16_and_TUInt16_tpl_end_},
    };
    TInt32 nBegin = 0;
    TInt32 nEnd = 3;
